...
TEST(CalcTest, Rotation3D) {
	...
	std::vector<test_case_type> test_cases = {
		{ {1, 1, 1}, {1, 1, 1}, {0, 0, 0} },
		{ {1, 1, 1}, {1, -1, -1}, {M_PI, 0, 0} },
		{ {1, 1, 1}, {-1, 1, -1}, {0, M_PI, 0} },
		{ {1, 1, 1}, {-1, -1, 1}, {0, 0, M_PI} },
		{ {1, 1, 1}, {1, -1, -1}, {0, M_PI, M_PI} },
		{ {1, 1, 1}, {-1, 1, -1}, {M_PI, 0, M_PI} },
		{ {1, 1, 1}, {-1, -1, 1}, {M_PI, M_PI, 0} },
		{ {1, 1, 1}, {1, 1, 1}, {M_PI, M_PI, M_PI} }
	};
